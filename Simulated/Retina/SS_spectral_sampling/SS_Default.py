...
class DefaultSpectralSampling(AbstractSpectralSampling):
    def __init__(self, params, device):
        super(DefaultSpectralSampling, self).__init__(params, device)
        ...
        if not params['Experiment']['simulating_tetra']:
            cone_fundamental_peaks = [560, 530, 419]
            self.cone_types = ['L', 'M', 'S']
        else: # tetrachromacy
